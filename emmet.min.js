...
b.source&&a.global==b.global&&a.multiline==b.multiline&&a.ignoreCase==b.ignoreCase}if(typeof a!="object"||typeof b!="object")return!1;for(var d=c.length;d--;)if(c[d]==a)return!0;c.push(a);var d=0,j=!0;if(g=="[object Array]"){if(d=a.length,j=d==b.length)for(;d--;)if(!(j=d in a==d in b&&f(a[d],b[d],c)))break}else{if("constructor"in a!="constructor"in b||a.constructor!=b.constructor)return!1;for(var l in a)if(k.has(a,l)&&(d++,!(j=k.has(b,l)&&f(a[l],b[l],c))))break;if(j){for(l in b)if(k.has(b,l)&&!d--)break;
j=!d}}c.pop();return j}var d=this,h=d._,i={},b=Array.prototype,c=Object.prototype,a=b.slice,g=b.unshift,e=c.toString,j=c.hasOwnProperty,l=b.forEach,o=b.map,m=b.reduce,n=b.reduceRight,p=b.filter,r=b.every,q=b.some,u=b.indexOf,s=b.lastIndexOf,c=Array.isArray,v=Object.keys,w=Function.prototype.bind,k=function(a){return new x(a)};if(typeof exports!=="undefined"){if(typeof module!=="undefined"&&module.exports)exports=module.exports=k;exports._=k}else d._=k;k.VERSION="1.3.3";var t=k.each=k.forEach=function(a,
b,c){if(a!=null)if(l&&a.forEach===l)a.forEach(b,c);else if(a.length===+a.length)for(var e=0,g=a.length;e<g;e++){if(e in a&&b.call(c,a[e],e,a)===i)break}else for(e in a)if(k.has(a,e)&&b.call(c,a[e],e,a)===i)break};k.map=k.collect=function(a,b,c){var e=[];if(a==null)return e;if(o&&a.map===o)return a.map(b,c);t(a,function(a,g,d){e[e.length]=b.call(c,a,g,d)});if(a.length===+a.length)e.length=a.length;return e};k.reduce=k.foldl=k.inject=function(a,b,c,e){var g=arguments.length>2;a==null&&(a=[]);if(m&&
a.reduce===m)return e&&(b=k.bind(b,e)),g?a.reduce(b,c):a.reduce(b);t(a,function(a,d,k){g?c=b.call(e,c,a,d,k):(c=a,g=!0)});if(!g)throw new TypeError("Reduce of empty array with no initial value");return c};k.reduceRight=k.foldr=function(a,b,c,e){var g=arguments.length>2;a==null&&(a=[]);if(n&&a.reduceRight===n)return e&&(b=k.bind(b,e)),g?a.reduceRight(b,c):a.reduceRight(b);var d=k.toArray(a).reverse();e&&!g&&(b=k.bind(b,e));return g?k.reduce(d,b,c,e):k.reduce(d,b)};k.find=k.detect=function(a,b,c){var e;
D(a,function(a,g,d){if(b.call(c,a,g,d))return e=a,!0});return e};k.filter=k.select=function(a,b,c){var e=[];if(a==null)return e;if(p&&a.filter===p)return a.filter(b,c);t(a,function(a,g,d){b.call(c,a,g,d)&&(e[e.length]=a)});return e};k.reject=function(a,b,c){var e=[];if(a==null)return e;t(a,function(a,g,d){b.call(c,a,g,d)||(e[e.length]=a)});return e};k.every=k.all=function(a,b,c){var e=!0;if(a==null)return e;if(r&&a.every===r)return a.every(b,c);t(a,function(a,g,d){if(!(e=e&&b.call(c,a,g,d)))return i});
return!!e};var D=k.some=k.any=function(a,b,c){b||(b=k.identity);var e=!1;if(a==null)return e;if(q&&a.some===q)return a.some(b,c);t(a,function(a,g,d){if(e||(e=b.call(c,a,g,d)))return i});return!!e};k.include=k.contains=function(a,b){var c=!1;return a==null?c:u&&a.indexOf===u?a.indexOf(b)!=-1:c=D(a,function(a){return a===b})};k.invoke=function(b,c){var e=a.call(arguments,2);return k.map(b,function(a){return(k.isFunction(c)?c||a:a[c]).apply(a,e)})};k.pluck=function(a,b){return k.map(a,function(a){return a[b]})};
k.max=function(a,b,c){if(!b&&k.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&k.isEmpty(a))return-Infinity;var e={computed:-Infinity};t(a,function(a,g,d){g=b?b.call(c,a,g,d):a;g>=e.computed&&(e={value:a,computed:g})});return e.value};k.min=function(a,b,c){if(!b&&k.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&k.isEmpty(a))return Infinity;var e={computed:Infinity};t(a,function(a,g,d){g=b?b.call(c,a,g,d):a;g<e.computed&&(e={value:a,computed:g})});return e.value};k.shuffle=
function(a){var b=[],c;t(a,function(a,e){c=Math.floor(Math.random()*(e+1));b[e]=b[c];b[c]=a});return b};k.sortBy=function(a,b,c){var e=k.isFunction(b)?b:function(a){return a[b]};return k.pluck(k.map(a,function(a,b,g){return{value:a,criteria:e.call(c,a,b,g)}}).sort(function(a,b){var c=a.criteria,e=b.criteria;return c===void 0?1:e===void 0?-1:c<e?-1:c>e?1:0}),"value")};k.groupBy=function(a,b){var c={},e=k.isFunction(b)?b:function(a){return a[b]};t(a,function(a,b){var g=e(a,b);(c[g]||(c[g]=[])).push(a)});
return c};k.sortedIndex=function(a,b,c){c||(c=k.identity);for(var e=0,g=a.length;e<g;){var d=e+g>>1;c(a[d])<c(b)?e=d+1:g=d}return e};k.toArray=function(b){return!b?[]:k.isArray(b)?a.call(b):k.isArguments(b)?a.call(b):b.toArray&&k.isFunction(b.toArray)?b.toArray():k.values(b)};k.size=function(a){return k.isArray(a)?a.length:k.keys(a).length};k.first=k.head=k.take=function(b,c,e){return c!=null&&!e?a.call(b,0,c):b[0]};k.initial=function(b,c,e){return a.call(b,0,b.length-(c==null||e?1:c))};k.last=function(b,
c,e){return c!=null&&!e?a.call(b,Math.max(b.length-c,0)):b[b.length-1]};k.rest=k.tail=function(b,c,e){return a.call(b,c==null||e?1:c)};k.compact=function(a){return k.filter(a,function(a){return!!a})};k.flatten=function(a,b){return k.reduce(a,function(a,c){if(k.isArray(c))return a.concat(b?c:k.flatten(c));a[a.length]=c;return a},[])};k.without=function(b){return k.difference(b,a.call(arguments,1))};k.uniq=k.unique=function(a,b,c){var c=c?k.map(a,c):a,e=[];a.length<3&&(b=!0);k.reduce(c,function(c,g,
d){if(b?k.last(c)!==g||!c.length:!k.include(c,g))c.push(g),e.push(a[d]);return c},[]);return e};k.union=function(){return k.uniq(k.flatten(arguments,!0))};k.intersection=k.intersect=function(b){var c=a.call(arguments,1);return k.filter(k.uniq(b),function(a){return k.every(c,function(b){return k.indexOf(b,a)>=0})})};k.difference=function(b){var c=k.flatten(a.call(arguments,1),!0);return k.filter(b,function(a){return!k.include(c,a)})};k.zip=function(){for(var b=a.call(arguments),c=k.max(k.pluck(b,"length")),
e=Array(c),g=0;g<c;g++)e[g]=k.pluck(b,""+g);return e};k.indexOf=function(a,b,c){if(a==null)return-1;var e;if(c)return c=k.sortedIndex(a,b),a[c]===b?c:-1;if(u&&a.indexOf===u)return a.indexOf(b);c=0;for(e=a.length;c<e;c++)if(c in a&&a[c]===b)return c;return-1};k.lastIndexOf=function(a,b){if(a==null)return-1;if(s&&a.lastIndexOf===s)return a.lastIndexOf(b);for(var c=a.length;c--;)if(c in a&&a[c]===b)return c;return-1};k.range=function(a,b,c){arguments.length<=1&&(b=a||0,a=0);for(var c=arguments[2]||1,
e=Math.max(Math.ceil((b-a)/c),0),g=0,d=Array(e);g<e;)d[g++]=a,a+=c;return d};var E=function(){};k.bind=function(b,c){var e,g;if(b.bind===w&&w)return w.apply(b,a.call(arguments,1));if(!k.isFunction(b))throw new TypeError;g=a.call(arguments,2);return e=function(){if(!(this instanceof e))return b.apply(c,g.concat(a.call(arguments)));E.prototype=b.prototype;var d=new E,k=b.apply(d,g.concat(a.call(arguments)));return Object(k)===k?k:d}};k.bindAll=function(b){var c=a.call(arguments,1);c.length==0&&(c=k.functions(b));
t(c,function(a){b[a]=k.bind(b[a],b)});return b};k.memoize=function(a,b){var c={};b||(b=k.identity);return function(){var e=b.apply(this,arguments);return k.has(c,e)?c[e]:c[e]=a.apply(this,arguments)}};k.delay=function(b,c){var e=a.call(arguments,2);return setTimeout(function(){return b.apply(null,e)},c)};k.defer=function(b){return k.delay.apply(k,[b,1].concat(a.call(arguments,1)))};k.throttle=function(a,b){var c,e,g,d,j,l,f=k.debounce(function(){j=d=!1},b);return function(){c=this;e=arguments;var k;
g||(g=setTimeout(function(){g=null;j&&a.apply(c,e);f()},b));d?j=!0:l=a.apply(c,e);f();d=!0;return l}};k.debounce=function(a,b,c){var e;return function(){var g=this,d=arguments;c&&!e&&a.apply(g,d);clearTimeout(e);e=setTimeout(function(){e=null;c||a.apply(g,d)},b)}};k.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};k.wrap=function(b,c){return function(){var e=[b].concat(a.call(arguments,0));return c.apply(this,e)}};k.compose=function(){var a=arguments;
...
1),function(a){for(var c in a)b[c]=a[c]});return b};k.pick=function(b){var c={};t(k.flatten(a.call(arguments,1)),function(a){a in b&&(c[a]=b[a])});return c};k.defaults=function(b){t(a.call(arguments,1),function(a){for(var c in a)b[c]==null&&(b[c]=a[c])});return b};k.clone=function(a){return!k.isObject(a)?a:k.isArray(a)?a.slice():k.extend({},a)};k.tap=function(a,b){b(a);return a};k.isEqual=function(a,b){return f(a,b,[])};k.isEmpty=function(a){if(a==null)return!0;if(k.isArray(a)||k.isString(a))return a.length===
...
emmet.define("abbreviationParser",function(f,d){function h(){this.parent=null;this.children=[];this._attributes=[];this.abbreviation="";this.counter=1;this._name=null;this._text="";this.repeatCount=1;this.hasImplicitRepeat=!1;this._data={};this.padding=this.content=this.end=this.start=""}function i(a){return a.substring(1,a.length-1)}function b(a){for(var a=f("utils").trim(a),c=new h,e=c.addChild(),g,j=f("stringStream").create(a),a=1E3,l;!j.eol()&&--a>0;)switch(g=j.peek(),g){case "(":j.start=j.pos;
if(j.skipToPair("(",")"))g=b(i(j.current())),(l=j.match(/^\*(\d+)?/,!0))&&e._setRepeat(l[1]),d.each(g.children,function(a){e.addChild(a)});else throw'Invalid abbreviation: mo matching ")" found for character at '+j.pos;break;case ">":e=e.addChild();j.next();break;case "+":e=e.parent.addChild();j.next();break;case "^":g=e.parent||e;e=(g.parent||g).addChild();j.next();break;default:j.start=j.pos,j.eatWhile(function(a){if(a=="["||a=="{"){if(j.skipToPair(a,p[a]))return j.backUp(1),!0;throw'Invalid abbreviation: mo matching "'+
p[a]+'" found for character at '+j.pos;}return a=="+"?(j.next(),a=j.eol()||~"+>^*".indexOf(j.peek()),j.backUp(1),a):a!="("&&o(a)}),e.setAbbreviation(j.current()),j.start=j.pos}if(a<1)throw"Endless loop detected";return c}function c(a){var a=f("utils").trim(a),b=[],a=f("stringStream").create(a);for(a.eatSpace();!a.eol();)if(a.start=a.pos,a.eatWhile(n)){var c=a.current(),e="";if(a.peek()=="="){a.next();a.start=a.pos;var d=a.peek();if(d=='"'||d=="'"){a.next();a:{for(var e=a,g=void 0;g=e.next();)if(g===
d){e=!0;break a}e=!1}if(e)e=a.current(),e=e.substring(1,e.length-1);else throw"Invalid attribute value";}else if(a.eatWhile(/[^\s\]]/))e=a.current();else throw"Invalid attribute value";}b.push({name:c,value:e});a.eatSpace()}else break;return b}function a(a){for(var b=[],e={"#":"id",".":"class"},d=null,j=f("stringStream").create(a);!j.eol();)switch(j.peek()){case "#":case ".":if(d===null)d=j.pos;var l=e[j.peek()];j.next();j.start=j.pos;j.eatWhile(n);b.push({name:l,value:j.current()});break;case "[":if(d===
null)d=j.pos;j.start=j.pos;if(!j.skipToPair("[","]"))throw"Invalid attribute set definition";b=b.concat(c(i(j.current())));break;default:j.next()}return!b.length?null:{element:a.substring(0,d),attributes:g(b)}}function g(a){var a=d.map(a,function(a){return d.clone(a)}),b={};return d.filter(a,function(a){if(!(a.name in b))return b[a.name]=a;var c=b[a.name];a.name.toLowerCase()=="class"?c.value+=(c.value.length?" ":"")+a.value:c.value=a.value;return!1})}function e(a){if(!~a.indexOf("{"))return null;
for(var b=f("stringStream").create(a);!b.eol();)switch(b.peek()){case "[":case "(":b.skipToPair(b.peek(),p[b.peek()]);break;case "{":return b.start=b.pos,b.skipToPair("{","}"),{element:a.substring(0,b.start),text:i(b.current())};default:b.next()}}function j(a){for(var b=a.children.length-1,c,e,g;b>=0;b--)if(e=a.children[b],e.isRepeating()){g=c=e.repeatCount;e.repeatCount=1;e.updateProperty("counter",1);for(e.updateProperty("maxCount",g);--c>0;)e.parent.addChild(e.clone(),b+1).updateProperty("counter",
c+1).updateProperty("maxCount",g)}d.each(a.children,j);return a}function l(a){for(var b=a.children.length-1;b>=0;b--){var c=a.children[b];c.isGroup()?c.replace(l(c).children):c.isEmpty()&&c.remove()}d.each(a.children,l);return a}function o(a){var b=a.charCodeAt(0);return b>64&&b<91||b>96&&b<123||b>47&&b<58||"#.*:$-_!@|%".indexOf(a)!=-1}var m=/^[\w\-\$\:@\!%]+\+?$/i,n=/[\w\-:\$@]/,p={"[":"]","(":")","{":"}"},r=Array.prototype.splice,q=[],u=[],s=[];h.prototype={addChild:function(a,b){a=a||new h;a.parent=
...
parseInt(a,10)||1:this.hasImplicitRepeat=!0},setAbbreviation:function(b){var c=this;this.abbreviation=b=(b||"").replace(/\*(\d+)?$/,function(a,b){c._setRepeat(b);return""});var d=e(b);if(d)b=d.element,this.content=this._text=d.text;if(d=a(b))b=d.element,this._attributes=d.attributes;if((this._name=b)&&!m.test(this._name))throw"Invalid abbreviation";},toString:function(){var a=f("utils"),b=this.start,c=this.end,e=this.content,g=this;d.each(s,function(a){b=a(b,g,"start");e=a(e,g,"content");c=a(c,g,
"end")});var j=d.map(this.children,function(a){return a.toString()}).join(""),e=f("abbreviationUtils").insertChildContent(e,j,{keepVariable:!1});return b+a.padString(e,this.padding)+c},hasEmptyChildren:function(){return!!d.find(this.children,function(a){return a.isEmpty()})},hasImplicitName:function(){return!this._name&&!this.isTextNode()},isGroup:function(){return!this.abbreviation},isEmpty:function(){return!this.abbreviation&&!this.children.length},isRepeating:function(){return this.repeatCount>
1||this.hasImplicitRepeat},isTextNode:function(){return!this.name()&&!this.attributeList().length},isElement:function(){return!this.isEmpty()&&!this.isTextNode()},deepestChild:function(){if(!this.children.length)return null;for(var a=this;a.children.length;)a=d.last(a.children);return a}};s.push(function(a,b){return f("utils").replaceCounter(a,b.counter,b.maxCount)});return{parse:function(a,c){var c=c||{},e=b(a);if(c.contextNode){e._name=c.contextNode.name;var g={};d.each(e._attributes,function(a){g[a.name]=
a});d.each(c.contextNode.attributes,function(a){a.name in g?g[a.name].value=a.value:(a=d.clone(a),e._attributes.push(a),g[a.name]=a)})}d.each(q,function(a){a(e,c)});e=l(j(e));d.each(u,function(a){a(e,c)});return e},AbbreviationNode:h,addPreprocessor:function(a){d.include(q,a)||q.push(a)},removeFilter:function(a){preprocessor=d.without(q,a)},addPostprocessor:function(a){d.include(u,a)||u.push(a)},removePostprocessor:function(a){u=d.without(u,a)},addOutputProcessor:function(a){d.include(s,a)||s.push(a)},
...
emmet.exec(function(f,d){function h(a){for(var b=f("range"),c=[],a=f("stringStream").create(a);!a.eol();){if(a.peek()=="\\")a.next();else if(a.start=a.pos,a.match(g,!0)){c.push(b.create(a.start,g));continue}a.next()}return c}function i(a,b){var c=f("utils"),g=h(a);g.reverse();d.each(g,function(d){a=c.replaceSubstring(a,b,d)});return a}function b(a){return h(a.content).length?!0:!!d.find(a.attributeList(),function(a){return!!h(a.value).length})}function c(a,c,g){var h=a.findAll(function(a){return b(a)});
...
" char "+(d+1),walker:c,tokens:j}}function a(a){var c=e,g=c.ch,d=i(),j=a?a+g:g,g=c.nextChar();for(a&&(d["char"]-=a.length);o(g)||m(g);)j+=g,g=c.nextChar();b(j,"identifier",d)}function g(){var g=e.ch;if(g===" "||g==="\t"){for(var d=e.ch,j="",f=i();d===" "||d==="\t";)j+=d,d=e.nextChar();b(j,"white",f)}else{if(g==="/"){var d=e,g=f=d.ch,h,s=i();h=d.nextChar();if(h!=="*")s.charend=s["char"],s.lineend=s.line,j=b(g,g,s);else{for(;!(f==="*"&&h==="/");)g+=h,f=h,h=d.nextChar();g+=h;d.nextChar();b(g,"comment",
s)}return j}if(g==='"'||g==="'"){d=e;g=f=j=d.ch;s=i();for(j=d.nextChar();j!==f;){if(j==="\n")if(h=d.nextChar(),h==="\\")g+=j+h;else throw c("Unterminated string",s);else g+=j==="\\"?j+d.nextChar():j;j=d.nextChar()}g+=j;d.nextChar();b(g,"string",s)}else if(g==="("){d=e;j=d.ch;f=0;g=j;h=i();for(j=d.nextChar();j!==")"&&!f;){if(j==="(")f++;else if(j===")")f--;else if(j===!1)throw c("Unterminated brace",h);g+=j;j=d.nextChar()}g+=j;d.nextChar();b(g,"brace",h)}else{if(g==="-"||g==="."||m(g)){j=e;f=j.ch;
g=i();h=f;var s=h===".",v,f=j.nextChar();v=!m(f);if(s&&v)g.charend=g["char"],g.lineend=g.line,d=b(h,".",g);else if(h==="-"&&v)d=a("-");else{for(;f!==!1&&(m(f)||!s&&f===".");)f==="."&&(s=!0),h+=f,f=j.nextChar();b(h,"number",g)}return d}if(o(g))return a();if(l(g))return d=e,g=d.ch,j=i(),h=d.nextChar(),h==="="&&l(g,!0)?(g+=h,b(g,"match",j),d.nextChar(),f=void 0):(j.charend=j["char"]+1,j.lineend=j.line,b(g,g,j)),f;if(g==="\n")b("line"),e.nextChar();else throw c("Unrecognized character");}}}var e,j=[],
l,o,m;e={lines:null,total_lines:0,linenum:-1,line:"",ch:"",chnum:-1,init:function(a){var b=e;b.lines=a.replace(/\r\n/g,"\n").replace(/\r/g,"\n").split("\n");b.total_lines=b.lines.length;b.chnum=-1;b.linenum=-1;b.ch="";b.line="";b.nextLine();b.nextChar()},nextLine:function(){this.linenum+=1;this.line=this.total_lines<=this.linenum?!1:this.lines[this.linenum];if(this.chnum!==-1)this.chnum=0;return this.line},nextChar:function(){for(this.chnum+=1;this.line.charAt(this.chnum)==="";){if(this.nextLine()===
...
"openTag")return k.tagName=v,g(n,l(k.startOfLine));else if(a=="closeTag")return a=!1,k.context?k.context.tagName!=v&&(s.implicitlyClosed.hasOwnProperty(k.context.tagName.toLowerCase())&&e(),a=!k.context||k.context.tagName!=v):a=!0,a&&(t="error"),g(o(a));return g()}function l(a){return function(b){if(b=="selfcloseTag"||b=="endTag"&&s.autoSelfClosers.hasOwnProperty(k.tagName.toLowerCase()))return m(k.tagName.toLowerCase()),g();if(b=="endTag"){m(k.tagName.toLowerCase());var b=k.tagName,c=s.doNotIndent.hasOwnProperty(b)||
k.context&&k.context.noIndent;k.context={prev:k.context,tagName:b,indent:k.indented,startOfLine:a,noIndent:c}}return g()}}function o(a){return function(b){a&&(t="error");if(b=="endTag")return e(),g();t="error";return g(arguments.callee)}}function m(a){for(var b;;){if(!k.context)break;b=k.context.tagName.toLowerCase();if(!s.contextGrabbers.hasOwnProperty(b)||!s.contextGrabbers[b].hasOwnProperty(a))break;e()}}function n(b){if(b=="word")return t="attribute",g(p,n);if(b=="endTag"||b=="selfcloseTag")return a();
t="error";return g(n)}function p(b){if(b=="equals")return g(r,n);s.allowMissing||(t="error");return b=="endTag"||b=="selfcloseTag"?a():g()}function r(b){if(b=="string")return g(q);if(b=="word"&&s.allowUnquoted)return t="string",g();t="error";return b=="endTag"||b=="selfCloseTag"?a():g()}function q(b){return b=="string"?g(q):a()}function u(a,b){if(a.sol())b.startOfLine=!0,b.indented=0;if(a.eatSpace())return null;t=w=v=null;var c=b.tokenize(a,b);b.type=w;if((c||w)&&c!="comment")for(k=b;;)if((b.cc.pop()||
...
emmet.define("string-score",function(){return{score:function(f,d,h){if(f==d)return 1;if(d=="")return 0;for(var i=0,b=d.length,c=f.length,a,g=1,e=0,j,l,o,m;e<b;++e){o=d.charAt(e);j=f.indexOf(o.toLowerCase());l=f.indexOf(o.toUpperCase());m=Math.min(j,l);l=m>-1?m:Math.max(j,l);if(l===-1)if(h){g+=1-h;continue}else return 0;else j=0.1;f[l]===o&&(j+=0.1);l===0?(j+=0.6,e===0&&(a=1)):f.charAt(l-1)===" "&&(j+=0.8);f=f.substring(l+1,c);i+=j}f=i/b;b=(f*(b/c)+f)/2;b/=g;a&&b+0.15<1&&(b+=0.15);return b}}});
...
this;return this.replaceUnescapedSymbol(b,"$",function(b,j,f){if(b.charAt(f+1)=="{"||g.isNumeric(b.charAt(f+1)))return!1;for(j=f+1;b.charAt(j)=="$"&&b.charAt(j+1)!="{";)j++;var h=j-f,i=0,n=!1,p;if(p=b.substr(j).match(/^@(\-?)(\d*)/))j+=p[0].length,p[1]&&(n=!0),i=parseInt(p[2]||1)-1;n&&a&&d.isNumber(c)&&(c=a-c+1);c+=i;return[b.substring(f,j),g.zeroPadString(c+"",h)]})},matchesTag:function(b){return this.reTag.test(b||"")},escapeText:function(b){return b.replace(/([\$\\])/g,"\\$1")},unescapeText:function(b){return b.replace(/\\(.)/g,
...
"snippet")},hasTagsInContent:function(d){return f("utils").matchesTag(d.content)},hasBlockChildren:function(f){return this.hasTagsInContent(f)&&this.isBlock(f)||d.any(f.children,function(d){return this.isBlock(d)},this)},insertChildContent:function(h,i,b){var b=d.extend({keepVariable:!0,appendIfNoChild:!0},b||{}),c=!1,a=f("utils"),h=a.replaceVariables(h,function(g,d,f){var l=g;d=="child"&&(l=a.padString(i,a.getLinePaddingFromPosition(h,f.start)),c=!0,b.keepVariable&&(l+=g));return l});!c&&b.appendIfNoChild&&
(h+=i);return h}}});
...
emmet.define("htmlMatcher",function(f,d){function h(b){var d={},j;return{open:function(a){return(a=this.matches(a))&&a.type=="open"?a:null},close:function(a){return(a=this.matches(a))&&a.type=="close"?a:null},matches:function(h){var i="p"+h;if(!(i in d)&&b.charAt(h)=="<"){var m=b.slice(h);d[i]=(j=m.match(c))?{name:j[1],selfClose:!!j[3],range:f("range").create(h,j[0]),type:"open"}:(j=m.match(a))?{name:j[1],range:f("range").create(h,j[0]),type:"close"}:!1}return d[i]},text:function(){return b}}}function i(a,
b,c){return a.substring(b,b+c.length)==c}function b(a,b){for(var c=[],f=null,h=b.text(),m=a.range.end,n=h.length;m<n;m++){if(i(h,m,"<\!--"))for(f=m;f<n;f++)if(i(h,f,"--\>")){m=f+3;break}if(f=b.matches(m))if(f.type=="open"&&!f.selfClose)c.push(f.name);else if(f.type=="close"){if(!c.length)return f.name==a.name?f:null;if(d.last(c)==f.name)c.pop();else{for(var p=!1;c.length&&!p;)c.pop()==f.name&&(p=!0);if(!c.length&&!p)return f.name==a.name?f:null}}}}var c=/^<([\w\:\-]+)((?:\s+[\w\-:]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,
a=/^<\/([\w\:\-]+)[^>]*>/;return{find:function(a,c){for(var j=f("range"),l=h(a),o=null,m=null,n=c;n>=0;n--)if(o=l.open(n))if(o.selfClose){if(o.range.cmp(c,"lt","gt"))break}else{if(m=b(o,l)){if(j.create2(o.range.start,m.range.end).contains(c))break}else if(o.range.contains(c))break;o=null}else if(i(a,n,"--\>"))for(var p=n-1;p>=0;p--)if(i(a,p,"--\>"))break;else{if(i(a,p,"<\!--")){n=p;break}}else if(i(a,n,"<\!--")){p=n+4;for(o=a.length;p<o;p++)if(i(a,p,"--\>")){p+=3;break}o={range:f("range").create(n,
d.isNumber(p)?p-n:p[0]),type:"comment"};break}if(o)return p=n=null,m?(n=j.create2(o.range.start,m.range.end),p=j.create2(o.range.end,m.range.start)):n=p=j.create2(o.range.start,o.range.end),o.type=="comment"&&(j=n.substring(a),p.start+=j.length-j.replace(/^<\!--\s*/,"").length,p.end-=j.length-j.replace(/\s*--\>$/,"").length),{open:o,close:m,type:o.type=="comment"?"comment":"tag",innerRange:p,innerContent:function(){return this.innerRange.substring(a)},outerRange:n,outerContent:function(){return this.outerRange.substring(a)},
range:!p.length()||!p.cmp(c,"lte","gte")?n:p,content:function(){return this.range.substring(a)},source:a}},tag:function(a,b){var c=this.find(a,b);if(c&&c.type=="tag")return c}}});
emmet.define("tabStops",function(f,d){var h=100,i=0,b={replaceCarets:!1,escape:function(b){return"\\"+b},tabstop:function(b){return b.token},variable:function(b){return b.token}};f("abbreviationParser").addOutputProcessor(function(b,a){var d=0,e=f("tabStops"),j=f("utils"),h={tabstop:function(a){var b=parseInt(a.group);if(b==0)return"${0}";b>d&&(d=b);return a.placeholder?(b+=i,a=e.processText(a.placeholder,h),"${"+b+":"+a+"}"):"${"+(b+i)+"}"}},b=e.processText(b,h),b=j.replaceVariables(b,e.variablesResolver(a));
...
this.processText(c,a),h=g.stringBuilder(),i=0,g=d.map(j,function(a){h.append(c.substring(i,a.start));var b=h.length,d=e[a.group]||"";h.append(d);i=a.end;return{group:a.group,start:b,end:b+d.length}});h.append(c.substring(i));return{text:h.toString(),tabstops:d.sortBy(g,"start")}},processText:function(c,a){for(var a=d.extend({},b,a),g=f("utils").stringBuilder(),e=f("stringStream").create(c),j,h;j=e.next();)if(j=="\\"&&!e.eol())g.append(a.escape(e.next()));else{h=j;if(j=="$")if(e.start=e.pos-1,e.match(/^[0-9]+/))h=
...
for(this._positions.contentStart=e.position()+1;j=e.next();){if(r=j.type=="identifier")a:{r=e.tokens;q=e._i+1;for(var u=r.length;q<u;q++){if(r[q].type==":"){r=!0;break a}if(r[q].type=="identifier"||r[q].type=="line"){r=!1;break a}}r=!1}r&&(j=h(j),r=b(e),q=e.current()&&e.current().type==";"?h(e.current()):h(r.end,0),this._children.push(new l(this,g.createToken(j.start,j.substring(c)),g.createToken(r.start,r.substring(c)),g.createToken(q.start,q.substring(c)))))}this._saveStyle()},_saveStyle:function(){var a=
...
"styleSeparator"),h=f("editTree");if(d.isUndefined(c))c=g.length;var i=g[c];if(i)e=i.fullRange().start;else if(i=g[c-1])i.end(";"),e=i.range().end;i&&(j=d.pick(i,"styleBefore","styleSeparator"));a=h.createToken(e+j.styleBefore.length,a);b=h.createToken(a.end+j.styleSeparator.length,b);h=new l(this,a,b,h.createToken(b.end,";"));d.extend(h,j);this._updateSource(h.styleBefore+h.toString(),e);this._children.splice(c,0,h);return h}}),l=f("editTree").EditElement.extend({initialize:function(a,b,c,d){this.styleBefore=
...
this.styleSeparator+this.value()+this.end()}});return{parse:function(a,b){return new j(a,b)},parseFromPosition:function(a,b,c){c=this.extractRule(a,b,c);return!c||!c.inside(b)?null:this.parse(c.substring(a),{offset:c.start})},extractRule:function(a,b,c){for(var d="",g=a.length,e=-1,j;b>=0;){j=a.charAt(b);if(j=="{"){e=b;break}else if(j=="}"&&!c){b++;break}b--}for(;b<g;){j=a.charAt(b);if(j=="{")e=b;else if(j=="}"){e!=-1&&(d=a.substring(e,b+1));break}b++}if(d){b=e-1;for(c="";b>=0;){j=a.charAt(b);if("{}/\\<>\n\r".indexOf(j)!=
-1)break;b--}c=a.substring(b+1,e).replace(/^[\s\n\r]+/m,"");return f("range").create(e-c.length,d.length+c.length)}return null},baseName:function(a){return a.replace(/^\s*\-\w+\-/,"")},findParts:c}});
emmet.define("xmlEditTree",function(f,d){var h={styleBefore:" ",styleSeparator:"=",styleQuote:'"',offset:0},i=/^<([\w\:\-]+)((?:\s+[\w\-:]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/m,b=f("editTree").EditContainer.extend({initialize:function(a){d.defaults(this.options,h);this._positions.name=1;var b=null,e=f("xmlParser").parse(a),j=f("range");d.each(e,function(d){d.value=j.create(d).substring(a);switch(d.type){case "tag":if(/^<[^\/]+/.test(d.value))this._name=d.value.substring(1);
...
this.styleSeparator+this.styleQuote+this.value()+this.styleQuote}});return{parse:function(a,c){return new b(a,c)},parseFromPosition:function(a,b,c){c=this.extractTag(a,b,c);return!c||!c.inside(b)?null:this.parse(c.substring(a),{offset:c.start})},extractTag:function(a,b,c){var d=a.length,h,o=f("range"),m=Math.min(2E3,d),n=null,p=function(b){var c;if(a.charAt(b)=="<"&&(c=a.substr(b,m).match(i)))return o.create(b,c[0])};for(h=b;h>=0;h--)if(n=p(h))break;if(n&&(n.inside(b)||c))return n;if(!n&&c)return null;
for(h=b;h<d;h++)if(n=p(h))return n}}});
...
function(a){m-=a.length;return""}).replace(RegExp("\\s*"+p.escapeForRegexp(d)+"$"),"")}var h=f("editorUtils"),o=h.outputInfo(b).content,m=b.getCaretPos(),n=null,p=f("utils");(n=i(o,m,a,d))&&n.overlap(e)?(e=n,n=j(e.substring(o))):(n=a+" "+e.substring(o).replace(RegExp(p.escapeForRegexp(a)+"\\s*|\\s*"+p.escapeForRegexp(d),"g"),"")+" "+d,m+=a.length+1);return n!==null?(n=p.escapeText(n),b.setCaretPos(e.start),b.replaceContent(h.unindent(b,n),e.start,e.end),b.setCaretPos(m),!0):!1}f("actions").add("toggle_comment",
...
emmet.exec(function(f){function d(d,f,b){function c(b){for(var c=b;c>=0;){var d=a.charAt(c);if(d=="\n"||d=="\r")break;c--}return a.substring(c,b)}for(var f=f||1,b=d.getCaretPos()+(b||0),a=String(d.getContent()),d=a.length,g=-1,e=/^\s+$/;b<=d&&b>=0;){b+=f;var j=a.charAt(b),l=a.charAt(b+1),o=a.charAt(b-1);switch(j){case '"':case "'":l==j&&o=="="&&(g=b+1);break;case ">":l=="<"&&(g=b+1);break;case "\n":case "\r":e.test(c(b-1))&&(g=b)}if(g!=-1)break}return g}f=f("actions");f.add("prev_edit_point",function(f){var i=
...
emmet.exec(function(f,d){function h(a,b,c,d){var g=f("range"),e=f("editorUtils").outputInfo(a).content,j=e.length,h,i=g.create(-1,0),l=g.create(a.getSelectionRange());h=l.start;for(var n=1E5;h>=0&&h<j&&--n>0;){if(g=c(e,h,b)){if(i.equal(g))break;i=g.clone();if(h=d(g.substring(e),g.start,l.clone()))return a.createSelection(h.start,h.end),!0;else h=b?g.start:g.end-1}h+=b?-1:1}return!1}function i(a){var b=!0;return h(a,!1,function(a,c){if(b){b=!1;var d;a:{d=c;for(var g;d>=0;){if(g=e(a,d)){d=g;break a}d--}d=
null}return d}else return e(a,c)},function(a,b,c){return g(a,b,c,!1)})}function b(a){return h(a,!0,e,function(a,b,c){return g(a,b,c,!0)})}function c(b,c,g){var g=g||0,e=f("range"),h=[],k=-1,i="",l="",n,o;d.each(c,function(c){switch(c.type){case "tag":o=b.substring(c.start,c.end);/^<[\w\:\-]/.test(o)&&h.push(e.create({start:c.start+1,end:c.end}));break;case "attribute":k=c.start;i=b.substring(c.start,c.end);break;case "string":h.push(e.create(k,c.end-k)),n=e.create(c),l=n.substring(b),j(l.charAt(0))&&
n.start++,j(l.charAt(l.length-1))&&n.end--,h.push(n),i=="class"&&(h=h.concat(a(n.substring(b),n.start)))}});d.each(h,function(a){a.shift(g)});return d.chain(h).filter(function(a){return!!a.length()}).uniq(!1,function(a){return a.toString()}).value()}function a(a,b){var b=b||0,c=[],d=f("stringStream").create(a),g=f("range");d.eatSpace();d.start=d.pos;for(var e;e=d.next();)if(/[\s\u00a0]/.test(e))c.push(g.create(d.start+b,d.pos-d.start-1)),d.eatSpace(),d.start=d.pos;c.push(g.create(d.start+b,d.pos-
d.start));return c}function g(a,b,g,e){a=c(a,f("xmlParser").parse(a),b);e&&a.reverse();return(b=d.find(a,function(a){return a.equal(g)}))?(e=d.indexOf(a,b),e<a.length-1?a[e+1]:null):e?d.find(a,function(a){return a.start<g.start}):!b&&(e=d.filter(a,function(a){return a.inside(g.end)}),e.length>1)?e[1]:d.find(a,function(a){return a.end>g.end})}function e(a,b){var c;if(a.charAt(b)=="<"&&(c=a.substring(b,a.length).match(p)))return f("range").create(b,c[0])}function j(a){return a=='"'||a=="'"}function l(a){var b=
a.valueRange(!0),c=[a.range(!0),b],g=f("stringStream"),e=f("cssEditTree"),j=f("range"),h=a.value();d.each(a.valueParts(),function(a){var f=a.clone();c.push(f.shift(b.start));var i=g.create(a.substring(h));if(i.match(/^[\w\-]+\(/,!0)){i.start=i.pos;i.skipToPair("(",")");var l=i.current();c.push(j.create(f.start+i.start,l));d.each(e.findParts(l),function(a){c.push(j.create(f.start+i.start+a.start,a.substring(l)))})}});return d.chain(c).filter(function(a){return!!a.length()}).uniq(!1,function(a){return a.toString()}).value()}
function o(a,b,c){var g=null,e=null,f=a.list(),j,h;c?(f.reverse(),j=function(a){return a.range(!0).start<=b.start},h=function(a){return a.start<b.start}):(j=function(a){return a.range(!0).end>=b.end},h=function(a){return a.end>b.start});for(;g=d.find(f,j);){a=l(g);c&&a.reverse();if(e=d.find(a,function(a){return a.equal(b)})){if(e=d.indexOf(a,e),e!=a.length-1){e=a[e+1];break}}else{e=d.filter(a,function(a){return a.inside(b.end)});if(e.length>1){e=e[1];break}if(e=d.find(a,h))break}e=null;b.start=b.end=
c?g.range(!0).start-1:g.range(!0).end+1}return e}function m(a,b,c){a=f("cssEditTree").parse(a,{offset:b});b=a.nameRange(!0);return c.end<b.end?b:o(a,c,!1)}function n(a,b,c){b=f("cssEditTree").parse(a,{offset:b});a=o(b,c,!0);return!a&&(b=b.nameRange(!0),c.start>b.start)?b:a}var p=/^<([\w\:\-]+)((?:\s+[\w\-:]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)>/,r=f("actions");r.add("select_next_item",function(a){return a.getSyntax()=="css"?h(a,!1,f("cssEditTree").extractRule,m):i(a)});r.add("select_previous_item",
function(a){return a.getSyntax()=="css"?h(a,!0,f("cssEditTree").extractRule,n):b(a)})});
...
h=b.value(),i=d.name();e=d.value();var m=f("cssEditTree"),n=f("utils"),j=m.baseName(j),i=m.baseName(i);e=j=="opacity"&&i=="filter"?e.replace(/opacity=[^)]*/i,"opacity="+Math.floor(parseFloat(h)*100)):j=="filter"&&i=="opacity"?(j=h.match(/opacity=([^)]*)/i))?n.prettifyNumber(parseInt(j[1])/100):e:h;d.value(e)}})},{order:-1});return{addHandler:function(c,a){b.add(c,a)},removeHandler:function(c){b.remove(c,options)}}});
...
emmet.exec(function(f,d){function h(b,a){var g=f("utils"),e=!1,j=!1,h=f("actionUtils").findExpressionBounds(b,function(a,b,c){return g.isNumeric(a)?!0:a=="."?!g.isNumeric(c.charAt(b+1))?!1:j?!1:j=!0:a=="-"?e?!1:e=!0:!1});if(h&&h.length()){var o=h.substring(String(b.getContent())),m=parseFloat(o);if(!d.isNaN(m)){m=g.prettifyNumber(m+a);if(/^(\-?)0+[1-9]/.test(o)){var n="";RegExp.$1&&(n="-",m=m.substring(1));m=m.split(".");m[0]=g.zeroPadString(m[0],i(o));m=n+m.join(".")}b.replaceContent(m,h.start,h.end);
...
"}";if(!o)for(var m=e,n=g.length,p;m<n;m++){p=g.charAt(m);if(p=="{")break;if(p=="}"){h="";o=!0;break}}o||(h+="}");c=j+a+c.getCaretPlaceholder()+h;b.replaceContent(c,e);return!0}return!1},{hidden:!0});h.add("insert_formatted_line_break",function(b){if(!h.run("insert_formatted_line_break_only",b)){for(var c=f("utils"),a=f("editorUtils").getCurrentLinePadding(b),d=String(b.getContent()),e=b.getCaretPos(),j=d.length,c=c.getNewline(),i="",o=b.getCurrentLineRange().end+1,m;o<j;o++)if(m=d.charAt(o),m==" "||
m=="\t")i+=m;else break;i.length>a.length?b.replaceContent(c+i,e,e,!0):b.replaceContent(c,e)}return!0},{hidden:!0})});
...
emmet.exec(function(f){function d(d,b,c){c=c||0;return b.charAt(c)==d.charAt(0)&&b.substr(c,d.length)==d}function h(d,b,c){var a=f("file"),g=f("actionUtils"),e=d.getFilePath();if(e===null)throw"You should save your file before using this action";var j=a.locateFile(e,b);if(j===null)throw"Can't find "+b+" file";a.read(j,function(e,h){if(e)throw"Unable to read "+j+": "+e;var m=f("base64").encode(String(h));if(!m)throw"Can't encode file content to base64";m="data:"+(g.mimeTypes[String(a.getExt(j))]||
...
a,!0);if(e){var g=e.itemFromPosition(a,!0),j;g&&(j=/url\((["']?)(.+?)\1\)/i.exec(g.value()||""))&&b(c,j[2],function(b){if(b){var g=e.range(!0);e.value("width",b.width+"px");e.value("height",b.height+"px",e.indexOf("width")+1);f("actionUtils").compoundUpdate(c,d.extend(g,{data:e.toString(),caret:a}))}})}}function b(b,a,d){var e=f("actionUtils");if(a){if(/^data:/.test(a))return b=f("base64").decode(a.replace(/^data\:.+?;.+?,/,"")),d(e.getImageSize(b));var j=f("file"),h=j.locateFile(b.getFilePath(),
a);if(h===null)throw"Can't find "+a+" file";j.read(h,function(a,b){if(a)throw"Unable to read "+h+": "+a;d(e.getImageSize(String(b)))})}}f("actions").add("update_image_size",function(b){d.include(["css","less","scss"],String(b.getSyntax()))?i(b):h(b);return!0})});
...
if(!d.isUndefined(c))return c}return q.get("css."+a)}function o(a,b,c){if(!d.isString(a))a=a.data;if(!i(a))return a;b&&(~a.indexOf(";")?a=a.split(";").join(" !important;"):a+=" !important");b=a.indexOf(":");a=a.substring(0,b).replace(/\s+$/,"")+l("valueSeparator",c)+f("utils").trim(a.substring(b+1));return a.replace(/\s*;\s*$/,l("propertyEnd",c))}function m(a){var b=q.getArray(a);d.each(q.getArray(a+"Addon"),function(a){a.charAt(0)=="-"?b=d.without(b,a.substr(1)):(a.charAt(0)=="+"&&(a=a.substr(1)),
b.push(a))});return b}var n=null,p={prefix:"emmet",obsolete:!1,transformName:function(a){return"-"+this.prefix+"-"+a},properties:function(){return m("css."+this.prefix+"Properties")||[]},supports:function(a){return d.include(this.properties(),a)}},r={},q=f("preferences");q.define("css.valueSeparator",": ","Defines a symbol that should be placed between CSS property and value when expanding CSS abbreviations.");q.define("css.propertyEnd",";","Defines a symbol that should be placed at the end of CSS property  when expanding CSS abbreviations.");
...
b){return d.include(v,b)&&a.isElement()?n.expandToSnippet(a.abbreviation,b):null});var w=f("expandAbbreviation");w.addHandler(function(a,b,c){if(!d.include(v,b))return!1;var e=a.getSelectionRange().end,g=w.findAbbreviation(a);return g&&(b=emmet.expandAbbreviation(g,b,c))?(g=e-g.length,c=e,a.getContent().charAt(e)==";"&&b.charAt(b.length-1)==";"&&c++,a.replaceContent(b,g,c),!0):!1});return n={addPrefix:j,supportsPrefix:g,prefixed:function(a,b){return g(a,b)?"-"+b+"-"+a:a},listPrefixes:function(){return d.map(r,
...
g):e=e.replace(/\.$/,"")+q.get(~e.indexOf(".")?"css.floatUnit":"css.intUnit");return e})},expand:function(a,b,c){var c=c||"css",g=f("resources"),j=q.get("css.autoInsertVendorPrefixes"),h;if(h=/^(.+)\!$/.test(a))a=RegExp.$1;var l=g.findSnippet(c,a);if(l&&!j)return o(l,h,c);var a=this.extractPrefixes(a),n=this.extractValues(a.property),a=d.extend(a,n);l?a.values=null:l=g.findSnippet(c,a.property);!l&&q.get("css.fuzzySearch")&&(l=g.fuzzyFindSnippet(c,a.property,parseFloat(q.get("css.fuzzySearchMinScore"))));
if(l){if(!d.isString(l))l=l.data}else l=a.property+":${1};";if(!i(l))return l;var m=this.splitSnippet(l),p=[];!b&&a.values&&(b=d.map(a.values,function(a){return this.normalizeValue(a,m.name)},this).join(" ")+";");m.value=b||m.value;var b=a.prefixes=="all"||!a.prefixes&&j?e(m.name,j&&a.prefixes!="all"):a.prefixes,v=[],w;d.each(b,function(a){a in r&&(w=r[a].transformName(m.name),v.push(w),p.push(o(w+":"+m.value,h,c)))});p.push(o(m.name+":"+m.value,h,c));v.push(m.name);if(q.get("css.alignVendor"))var s=
f("utils").getStringsPads(v),p=d.map(p,function(a,b){return s[b]+a});return p},expandToSnippet:function(a,b){var c=this.expand(a,null,b);return d.isArray(c)?c.join("\n"):!d.isString(c)?c.data:String(c)},splitSnippet:function(a){var b=f("utils"),a=b.trim(a);if(a.indexOf(":")==-1)return{name:a,value:"${1};"};a=a.split(":");return{name:b.trim(a.shift()),value:b.trim(a.join(":")).replace(/^(\$\{0\}|\$0)(\s*;?)$/,"${1}$2")}},getSyntaxPreference:l,transformSnippet:o}});
...
d)})});return c.sort(function(a,b){return b.name.length-a.name.length})}function j(a,b,c){var j=a.parent,h=f("utils"),i=f("preferences").get("css.alignVendor"),l=a.styleSeparator,n=a.styleBefore;d.each(j.getAll(g(a.name())),function(b){if(b!=a&&/gradient/i.test(b.value())){if(b.styleSeparator.length<l.length)l=b.styleSeparator;if(b.styleBefore.length<n.length)n=b.styleBefore;j.remove(b)}});if(i){if(n!=a.styleBefore){var m=a.fullRange();j._updateSource(n,m.start,m.start+a.styleBefore.length);a.styleBefore=
n}if(l!=a.styleSeparator)j._updateSource(l,a.nameRange().end,a.valueRange().start),a.styleSeparator=l}var o=a.value();c||(c=f("range").create(0,a.value()));a.value(function(a){return h.replaceSubstring(o,a,c)}(p.toString(b))+"${2}");b=e(b,a.name());if(i){i=d.pluck(b,"value");m=d.pluck(b,"name");i.push(a.value());m.push(a.name());var r=h.getStringsPads(d.map(i,function(a){return a.substring(0,a.indexOf("("))})),q=h.getStringsPads(m);a.name(d.last(q)+a.name());d.each(b,function(a,b){a.name=q[b]+a.name;
a.value=r[b]+a.value});a.value(d.last(r)+a.value())}d.each(b,function(b){j.add(b.name,b.value,j.indexOf(a))})}function l(a){var b=a.value(),c=null;return(a=d.find(a.valueParts(),function(a){return c=p.parse(a.substring(b))}))&&c?{gradient:c,valueRange:a}:null}function o(a,b){var c=s.get("css.gradient.defaultProperty");if(!c)return!1;var g=String(a.getContent()),j=f("range").create(a.getCurrentLineRange()),h=j.substring(g).replace(/^\s+/,function(a){j.start+=a.length;return""}).replace(/\s+$/,function(a){j.end-=
a.length;return""}),g=f("cssResolver");if(h=p.parse(h)){var i=e(h,c);i.push({name:c,value:p.toString(h)+"${2}"});var l=g.getSyntaxPreference("valueSeparator",b),n=g.getSyntaxPreference("propertyEnd",b);if(f("preferences").get("css.alignVendor")){var m=f("utils").getStringsPads(d.map(i,function(a){return a.value.substring(0,a.value.indexOf("("))}));d.each(i,function(a,b){a.value=m[b]+a.value})}i=d.map(i,function(a){return a.name+l+a.value+n});a.replaceContent(i.join("\n"),j.start,j.end);return!0}return!1}
function m(a,b){var c=null,e=f("cssEditTree").parseFromPosition(a,b,!0);e&&((c=e.itemFromPosition(b,!0))||(c=d.find(e.list(),function(a){return a.range(!0).end==b})));return{rule:e,property:c}}var n=["top","to bottom","0deg"],p=null,r=["css","less","sass","scss","stylus","styl"],q=/\d+deg/i,u=/top|bottom|left|right/i,s=f("preferences");s.define("css.gradient.prefixes","webkit, moz, o","A comma-separated list of vendor-prefixes for which values should be generated.");s.define("css.gradient.oldWebkit",
...
f("expandAbbreviation").addHandler(function(a,b,c){c=f("editorUtils").outputInfo(a,b,c);if(!d.include(r,c.syntax))return!1;var e=a.getCaretPos(),g=c.content,c=m(g,e);if(c.property){var h=l(c.property);if(h){var i=c.rule.options.offset||0,n=i+c.rule.toString().length;if(/[\n\r]/.test(c.property.value())){var p=c.property.valueRange(!0).start+h.valueRange.end,g=f("utils").replaceSubstring(g,";",p),e=m(g,e);e.property&&(h=l(e.property),c=e)}c.property.end(";");var e=c.property.name(),g=f("resources"),
p=f("preferences"),q=g.findSnippet(b,e);!q&&p.get("css.fuzzySearch")&&(q=g.fuzzyFindSnippet(b,e,parseFloat(p.get("css.fuzzySearchMinScore"))));if(q){if(!d.isString(q))q=q.data;b=f("cssResolver").splitSnippet(q).name}else b=void 0;b&&c.property.name(b);j(c.property,h.gradient,h.valueRange);a.replaceContent(c.rule.toString(),i,n,!0);return!0}}return o(a,b)});f("reflectCSSValue").addHandler(function(a){var b=f("utils"),c=l(a);if(!c)return!1;var e=a.value(),j=function(a){return b.replaceSubstring(e,a,
c.valueRange)};d.each(a.parent.getAll(g(a.name())),function(b){if(b!==a){var d=b.value().match(/^\s*(\-([a-z]+)\-)?linear\-gradient/);d?b.value(j(p.toString(c.gradient,d[2]||""))):b.value().match(/\s*\-webkit\-gradient/)&&b.value(j(p.oldWebkitLinearGradient(c.gradient)))}});return!0});return p={parse:function(a){var b=null;f("utils").trim(a).replace(/^([\w\-]+)\((.+?)\)$/,function(a,c,e){c=c.toLowerCase().replace(/^\-[a-z]+\-/,"");if(c=="linear-gradient"||c=="lg"){for(var a=n[0],e=f("stringStream").create(f("utils").trim(e)),
...
b(a,c):!0}var a=f("preferences");a.define("format.noIndentTags","html","A comma-separated list of tag names that should not get inner indentation.");a.define("format.forceIndentationForTags","body","A comma-separated list of tag names that should <em>always</em> get inner indentation.");f("filters").add("_format",function e(b,l,o){var o=o||0,m=f("abbreviationUtils");d.each(b.children,function(b){if(m.isSnippet(b)){if(b.start=b.end="",!h(b)&&l.tag_nl!==!1&&i(b,l)&&(!b.parent.parent||!f("abbreviationUtils").isInline(b.parent)))b.start=
f("utils").getNewline()+b.start}else{b.start=b.end="%s";var j=f("utils"),r=f("abbreviationUtils"),q=r.isUnary(b),j=j.getNewline(),u=d.include(a.getArray("format.noIndentTags")||[],b.name())?"":f("resources").getVariable("indentation");if(l.tag_nl!==!1){var s=l.tag_nl===!0&&(l.tag_nl_leaf||b.children.length);s||(s=d.include(a.getArray("format.forceIndentationForTags")||[],b.name()));if(!b.isTextNode()){if(i(b,l)){if(!h(b)&&(!r.isSnippet(b.parent)||b.index()))b.start=j+b.start;if(r.hasBlockChildren(b)||
b.children.length&&i(b.children[0],l)||s&&!q)b.end=j+b.end;if(r.hasTagsInContent(b)||s&&!b.children.length&&!q)b.start+=j+u}else if(r.isInline(b)&&b.parent&&f("abbreviationUtils").hasBlockChildren(b.parent)&&!h(b))b.start=j+b.start;else if(r.isInline(b)&&c(b,l))b.end=j+b.end;b.padding=u}}}e(b,l,o+1)});return b})});
...
d.each(c.children,function(c){if(!e.isSnippet(c)&&c.parent){var d=f("abbreviationUtils"),o=f("utils"),m=h(c,a),n=a.cursor(),d=d.isUnary(c),p=a.self_closing_tag&&d?"/":"",r="",r="%"+a.tagName(c.name());r.toLowerCase()=="%div"&&m&&m.indexOf("{")==-1&&(r="");c.end="";c.start=o.replaceSubstring(c.start,r+m+p+" ",c.start.indexOf("%s"),"%s");!c.children.length&&!d&&(c.start+=n)}b(c,a,g+1)});return c})});
...
d?(p="<"+q+m+a.selfClosing()+">",c.end=""):(p="<"+q+m+">",r="</"+q+">")}c.start=o.replaceSubstring(c.start,p,c.start.indexOf("%s"),"%s");c.end=o.replaceSubstring(c.end,r,c.end.indexOf("%s"),"%s");!c.children.length&&!d&&!~c.content.indexOf(n)&&!f("tabStops").extract(c.content).tabstops.length&&(c.start+=n)}b(c,a,g+1)});return c})});
...
emmet.exec(function(f,d){function h(a,b){return Math.round(Math.random()*(b-a)+a)}function i(a,b){for(var c=a.length,f=Math.min(c,b),g=[];g.length<f;){var i=h(0,c-1);d.include(g,i)||g.push(i)}return d.map(g,function(b){return a[b]})}function b(a,b){a.length&&(a[0]=a[0].charAt(0).toUpperCase()+a[0].substring(1));return a.join(" ")+(b||(d.isString("?!...")?"?!...".charAt(h(0,4)):"?!..."[h(0,4)]))}function c(a){var b=a.length,c=0,c=b>3&&b<=6?h(0,1):b>6&&b<=12?h(0,2):h(1,4);d.each(i(d.range(c)),function(b){a[b]+=
","})}f("abbreviationParser").addPreprocessor(function(d){var f=/^(?:lorem|lipsum)(\d*)$/i,l;d.findAll(function(d){if(d._name&&(l=d._name.match(f))){var e=l[1]||30;d._name="";d.data("forceNameResolving",d.isRepeating()||d.attributeList().length);d.data("pasteOverwrites",!0);d.data("paste",function(d){var f=e,j=!d,d=[],l=0,f=parseInt(f,10);j&&(j=a.slice(0,f),j.length>5&&(j[4]+=","),l+=j.length,d.push(b(j,".")));for(;l<f;)j=i(g,Math.min(h(3,12)*h(1,5),f-l)),l+=j.length,c(j),d.push(b(j));return d.join(" ")})}})});
...
"input:submit":'<input type="submit" value="" />',"input:s":"input:submit","input:image":'<input type="image" src="" alt="" />',"input:i":"input:i","input:button":'<input type="button" value="" />',"input:b":"input:button","input:reset":"input:button[type=reset]",select:'<select name="" id="">',option:'<option value="">',textarea:'<textarea name="" id="" cols="${1:30}" rows="${2:10}">',"menu:context":"menu[type=context]>","menu:c":"menu:context","menu:toolbar":"menu[type=toolbar]>","menu:t":"menu:toolbar",
...
d,h,i=0,o=a.length;i<o;i++)h=a[i],!f&&h=="meta"&&(h="ctrl"),h=="ctrl"||h=="control"?b|=c.CTRL:h=="shift"?b|=c.SHIFT:h=="alt"?b|=c.ALT:h=="meta"?b|=c.META:d=h;return{mask:b,key:d}},test:function(a,b){var e=0,f=this.compile(a);b.ctrlKey&&(e|=c.CTRL);b.shiftKey&&(e|=c.SHIFT);b.altKey&&(e|=c.ALT);b.metaKey&&(e|=c.META);var i=b.keyCode?b.keyCode:b.which,o=String.fromCharCode(i).toLowerCase();if(e!==f.mask)return!1;if(f.key.length>1)return h[f.key]==i;else{i==188&&(o=",");i==190&&(o=".");i==191&&(o="/");
if(o==f.key)return!0;if(b.shiftKey&&d[o])return d[o]==f.key}return!1},format:function(a){for(var c=f?i:b,d=f?"":"+",a=a.toLowerCase().split("+"),h=[],l,o=0;o<a.length;o++)l=a[o],h.push(l in c?c[l]:l.charAt().toUpperCase()+l.substring(1));return h.join(d)}}});
emmet.define("editor",function(f,d){var h=null,i=document.createElement("textarea");i.value="\n";f("utils").setNewline(i.value);i=null;return{setContext:function(b){h=b},getContext:function(){return h},getSelectionRange:function(){if("selectionStart"in h)return{start:h.selectionStart,end:h.selectionEnd};else if(document.selection){h.focus();var b=document.selection.createRange();if(b===null)return{start:0,end:this.getContent().length};var c=h.createTextRange(),a=c.duplicate();c.moveToBookmark(b.getBookmark());
a.setEndPoint("EndToStart",c);return{start:a.text.length,end:a.text.length+b.text.length}}else return null},createSelection:function(b,c){typeof c=="undefined"&&(c=b);if("setSelectionRange"in h)h.setSelectionRange(b,c);else if("createTextRange"in h){var a=h.createTextRange();a.collapse(!0);var d=f("utils"),e=d.splitByLines(this.getContent().substring(0,b)).length-1;c-=e+d.splitByLines(this.getContent().substring(b,c)).length-1;b-=e;a.moveStart("character",b);a.moveEnd("character",c-b);a.select()}},
getCurrentLineRange:function(){var b=this.getCaretPos();return b===null?null:f("utils").findNewlineBounds(this.getContent(),b)},getCaretPos:function(){var b=this.getSelectionRange();return b?b.start:null},setCaretPos:function(b){this.createSelection(b)},getCurrentLine:function(){var b=this.getCurrentLineRange();return b.start<b.end?this.getContent().substring(b.start,b.end):""},replaceContent:function(b,c,a,g){var e=this.getContent(),i=f("utils");d.isUndefined(a)&&(a=d.isUndefined(c)?e.length:c);
d.isUndefined(c)&&(c=0);g||(b=i.padString(b,i.getLinePaddingFromPosition(e,c)));g=emmet.require("tabStops").extract(b,{escape:function(a){return a}});b=g.text;(g=g.tabstops[0])?(g.start+=c,g.end+=c):g={start:b.length+c,end:b.length+c};try{h.value=i.replaceSubstring(e,b,c,a),this.createSelection(g.start,g.end)}catch(l){}},getContent:function(){return h.value||""},getSyntax:function(){return f("actionUtils").detectSyntax(this,f("textarea").getOption("syntax"))},getProfileName:function(){var b=f("textarea").getOption("profile");
return this.getSyntax()=="html"&&b?b:f("actionUtils").detectProfile(this)},prompt:function(b){return prompt(b)},getSelection:function(){var b=this.getSelectionRange();if(b)try{return this.getContent().substring(b.start,b.end)}catch(c){}return""},getFilePath:function(){return location.href}}});
emmet.define("textarea",function(f,d){function h(b){for(var c=f("editor").getContext().className||"",g=/\bemmet\-(\w+)\-(\w+)/g,h=d.extend({},a,e||{}),i;i=g.exec(c);){var j=i[1].toLowerCase();i=i[2].toLowerCase();if(i=="true"||i=="yes"||i=="1")i=!0;else if(i=="false"||i=="no"||i=="0")i=!1;h[j]=i}return h[b]}function i(a,b){g[a.toLowerCase()]={compiled:f("shortcut").compile(a),action:b}}function b(a){var a=a||window.event,b=a.target||a.srcElement,c=a.keyCode||a.which,e=f("editor"),i=f("shortcut");
if(b&&b.nodeType==1&&b.nodeName=="TEXTAREA"){if(~b.className.indexOf("no-emmet"))return!1;e.setContext(b);return!d.find(g,function(b){if(i.test(b.compiled,a)){b=b.action;switch(b){case "expand_abbreviation":if(c==9)if(h("use_tab"))b="expand_abbreviation_with_tab";else return!1;break;case "insert_formatted_line_break":if(c==13&&!h("pretty_break"))return!1}f("actions").run(b,e);b=a;b.cancelBubble=!0;b.returnValue=!1;b.stopPropagation&&(b.stopPropagation(),b.preventDefault());return!0}})}return!0}var c=
...
"Alt+Down":"decrement_number_by_01","Ctrl+Alt+Up":"increment_number_by_10","Ctrl+Alt+Down":"decrement_number_by_10","Meta+.":"select_next_item","Meta+,":"select_previous_item","Meta+Shift+B":"reflect_css_value",Enter:"insert_formatted_line_break"},a={syntax:"html",use_tab:!1,pretty_break:!1},g={},e={},j=document;j.addEventListener?j.addEventListener("keydown",b,!1):j.attachEvent?ele.attachEvent("onkeydown",b):j.onkeydown=func;e=d.extend({},a,{});typeof emmetKeymap!="undefined"&&(c=emmetKeymap);d.each(c,
function(a,b){i(b,a)});return{setOptions:function(b){e=d.extend({},a,b||{})},getOption:h,addShortcut:i,unbindShortcut:function(a){a=a.toLowerCase();a in g&&delete g[a]},getShortcuts:function(){var a=f("shortcut"),b=f("actions");return d.compact(d.map(g,function(c,e){var f=e.toLowerCase();return f=="tab"||f=="enter"?void 0:{keystroke:a.format(e),compiled:c.compiled,label:d.last((b.get(c.action).options.label||c.action).split("/")),action:c.action}}))},getInfo:function(){var a="This textareas on this page are powered by Emmet toolkit.\n\nAvailable shortcuts:\n",
